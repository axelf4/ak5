...
import ak5.graphics.GL20;
import ak5.graphics.Texture;
import ak5.graphics.Texture.Filter;
import ak5.platform.gwt.files.AssetLoader;
import ak5.platform.gwt.files.AutoClientBundle;
...
/** @author pwnedary */
public class GwtPlatform implements Platform, Handler { //, EntryPoint {
	...
	public class DefaultLoopListener implements LoopListener {
		...
		public void draw(float delta) {
			GwtPlatform.this.draw(new Drawable() {
				@Override
		...
		public boolean keepRunning() {
			return GwtPlatform.this.keepRunning();
		}
	}
